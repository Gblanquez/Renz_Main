...
var w = new (function() {
  ...
  return n2.toString = function(t4) {
    ...
    for (var i2, e2 = document.createElement("a"), o2 = 1; o2 < t4; o2++)
    ...
    return function(t4, n4, r4) {
      ...
      for (var i3 = r4.strict, e2 = void 0 !== i3 && i3, o2 = r4.start, u2 = void 0 === o2 || o2, s2 = r4.end, f2 = void 0 === s2 || s2, c2 = r4.encode, a2 = void 0 === c2 ? function(t5) {
        ...
        if ("string" == typeof E2)
          ...
          if (E2.pattern)
            if (n4 && n4.push(E2), g2 || x2)
              if ("+" === E2.modifier || "*" === E2.modifier) {
                var R2 = "*" === E2.modifier ? "?" : "";
                b2 += "(?:".concat(g2, "((?:").concat(E2.pattern, ")(?:").concat(x2).concat(g2, "(?:").concat(E2.pattern, "))*)").concat(x2, ")").concat(R2);
              } else
                b2 += "(?:".concat(g2, "(").concat(E2.pattern, ")").concat(x2, ")").concat(E2.modifier);
            else
              b2 += "+" === E2.modifier || "*" === E2.modifier ? "((?:".concat(E2.pattern, ")").concat(E2.modifier, ")") : "(".concat(E2.pattern, ")").concat(E2.modifier);
          else
            b2 += "(?:".concat(g2).concat(x2, ")").concat(E2.modifier);
        }
      }
      if (f2)
  ...
  return r2.get = function(t4, n2) {
    ...
    try {
      ...
      var c2 = W(function() {
            ...
            var r5 = function() {
              if (f2)
                return W(function() {
                  ...
                  if (u2.H(t8))
                    throw new G(t8, "Transition error [sync]");
                });
              var t7 = function(t8) {
                return W(function() {
                  var t9 = function() {
                  ...
                  if (u2.H(t9))
                    throw new G(t9, "Transition error [before/after/enter]");
                });
                ...
                if (u2.H(t8))
                  throw new G(t8, "Transition error [before/after/leave]");
              });
        ...
        var r4 = function() {
          if (f2)
            return Promise.resolve(P(i2, n2)).then(function() {
            });
        }();
...
var Z = new (function() {
  ...
  return i2.use = function(t4, n2) {
    ...
    if (d.setLevel(true === (void 0 !== R2 && R2) ? "debug" : void 0 === k2 ? "off" : k2), this.logger.info(this.version), Object.keys(f2).forEach(function(t5) {
      m[t5] && (m[t5] = f2[t5]);
    }), this.B = c2, this.timeout = h2, this.cacheIgnore = l2, this.cacheFirstPage = w2, this.prefetchIgnore = y2, this.preventRunning = E2, this.q = this.dom.getWrapper(), !this.q)
    ...
    try {
      ...
      var c2 = function() {
        if (s2.transitions.shouldWait)
          return Promise.resolve(P(o2, s2.data)).then(function() {
          });
      }();
